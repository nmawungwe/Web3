...
contract Exchange is ERC20 {
    ...
    constructor(address _CryptoDevtoken) ERC20("CryptoDev LP Token", "CDLP") {
        require(_CryptoDevtoken != address(0), "Token address pass is a null address");
     ...
     */
      ...
      */
    function addLiquidity(uint _amount) public payable returns (uint liquidityTokens) {
        uint liquidity;
    ...
    */
    function getAmountOfTokens(
        ...
        // Input amount with fee = (input amount - (1*(input amount)/100)) = ((input amount)*99)/10
        uint256 inputAmoutWithFee = inputAmount * 99;
        ...
        uint256 numerator = inputAmoutWithFee * outputReserve;
        uint256 denominator = (inputReserve * 100) + inputAmoutWithFee;
